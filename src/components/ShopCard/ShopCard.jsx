function ShopCard({ image, title, price, description, badge, onAddToCart }) {
  return (
    <div className="bg-white rounded-md border-1 border-[#E5E7EB] shadow-sm p-4 py-8 text-center flex flex-col transition-transform duration-300 hover:scale-105">
      {/* Product Image */}
